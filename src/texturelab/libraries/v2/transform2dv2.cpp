...
void Transform2DV2Node::init()
{
    ...
    this->addFloatProp("translateX", "Translate X", 0, -1.0, 1.0, 0.01);
    this->addFloatProp("translateY", "Translate Y", 0, -1.0, 1.0, 0.01);

    this->addFloatProp("scale", "Scale", 1, 0.0, 2.0, 0.01);
    this->addFloatProp("scaleX", "Scale X", 1, -2.0, 2.0, 0.01);
    this->addFloatProp("scaleY", "Scale Y", 1, -2.0, 2.0, 0.01);

    this->addFloatProp("rot", "Rotation", 0, 0.0, 360.0, 0.01);
    ...
    auto source = R""""(
        ...
        vec4 process(vec2 uv)
        {
            ...
            mat3 trans = transMat(vec2(0.5, 0.5)) *
                ...
                rotMat(prop_rot) *
                scaleMat(vec2(prop_scaleX, prop_scaleY) * prop_scale) *
