...
CapsuleNode::init()
{
    ...
    this->addFloatProp("radius", "Radius", 0.2, 0, 1.0, 0.01);
    this->addFloatProp("topRadius", "Top Radius", 0.0, 0.0, 0.5, 0.01);
    this->addFloatProp("bottomRadius", "Bottom Radius", 0.0, 0, 0.5, 0.01);
    this->addFloatProp("length", "Length", 0.6, 0, 2.0, 0.01);
