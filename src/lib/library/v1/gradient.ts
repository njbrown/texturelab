...
export class GradientNode extends DesignerNode {
  public init() {
    ...
    this.addColorProperty("colorA", "Color A", Color.parse("#000"));
    this.addFloatProperty("posA", "Position A", 0, 0, 1, 0.01);
    this.addColorProperty("colorB", "Color B", Color.parse("#FFF"));
    this.addFloatProperty("posB", "Position B", 0, 0, 1, 0.01);
