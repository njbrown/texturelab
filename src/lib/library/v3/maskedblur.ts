...
export class MaskedBlur extends GpuDesignerNode {
	public init() {
        ...
        this.addFloatProperty("opacity", "Opacity", 0.5, 0.0, 1.0, 0.01);
        ...
        {
            float finalMask = 1.0-texture(mask, uv).r;
            ...
            color.rgb = blur(image, uv, ps * prop_intensity * (1.0 - (finalMask*finalOpacity)) );
            color.a = 1.0;
